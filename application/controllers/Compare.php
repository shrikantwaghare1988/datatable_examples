...
class Compare extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->DB1 = $this->load->database('compare_development', TRUE); // load the source/development database
        $this->DB2 = $this->load->database('compare_live', TRUE); // load the destination/live database
    }
    ...
    {
        $conn = new mysqli($database["hostname"], $database["username"], $database["password"]);
    ...
    function determine_field_changes($source_field_structures, $destination_field_structures)
    {
         ...
         */
        //pre($source_field_structures);die;

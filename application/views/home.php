...
<html lang="en">
  ...
  <a href="<?php echo base_url()?>Employee/city_list" class="list-group-item list-group-item-action">City List</a>
  <a href="<?php echo base_url()?>Employee/salary_list" class="list-group-item list-group-item-action">Salary List</a>
